...
client.on('ready', () => {
	...
	let messages = ['Brawlstars!', 'https://github.com/moorad/the-beautiful-bot', 'with FL. Imagine not being able to FC with FL lol', `I'm in a total of ${client.guilds.size} servers`];
	let counter = 0;
